<?php
/*
Plugin Name:  Yandex.Money Payment Plugin AC
...
add_action('plugins_loaded', 'init_yandex_gatewayAC');

function init_yandex_gatewayAC()
{

    class WC_Gateway_YandexAC extends WC_Payment_Gateway
    {
        ...
        public function __construct()
        {
            ...
            $this->icon = plugins_url('/', 'yandexAC') . '/yandexAC/yandexAC.jpeg';
...
//            $order->wc_reduce_stock_levels();
    ...
    function add_your_gateway_classAC($methods)
    {
        $methods[] = 'WC_Gateway_YandexAC';
        return $methods;
    }

    add_filter('woocommerce_payment_gateways', 'add_your_gateway_classAC');
}
